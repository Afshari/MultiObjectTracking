...
Window {
    ...
    property int windowMargin: 0 // 10
    ...
    QtObject{
        ...
        function maximizeRestore(){
            if(windowStatus == 0){
                ...
                btnMaximizeRestore.btnIconSource = "../ui/images/svg_images/restore_icon.svg"
            }
            else{
                ...
                btnMaximizeRestore.btnIconSource = "../ui/images/svg_images/maximize_icon.svg"
            }
        }
        ...
        function pageNavigation( page_path ) {
            // btnImagePage.isActiveMenu = false
            btnHome.isActiveMenu = false
            btnSettings.isActiveMenu = false
            // btnPaintPage.isActiveMenu = false
            btnSingleObjectTracking.isActiveMenu = false
            btnMultiObjectTracking.isActiveMenu = false
            if(stackView.depth > 2)
                stackView.pop( 1 )
            stackView.push( Qt.resolvedUrl(page_path) )
            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    Image {
                        ...
                        anchors.top: parent.top
                        anchors.bottom: parent.bottom
                        source: "../ui/images/svg_images/icon_app_top.svg"
                        anchors.bottomMargin: 0
                ...
                Row {
                    ...
                    TopBarButton {
                        ...
                        btnIconSource: "../ui/images/svg_images/restore_icon.svg"
                    ...
                    TopBarButton {
                        ...
                        btnIconSource: "../ui/images/svg_images/close_icon.svg"
                        ...
                        LeftMenuBtn {
                            ...
                            onClicked: {
                                if(btnHome.isActiveMenu == false) {
                                    internal.pageNavigation("pages/homePage.qml")
...
//                        }
                        ...
                        LeftMenuBtn {
                            ...
                            width: leftMenu.width
                            text: qsTr("Single Object Tracking")
                            btnIconSource: "../ui/images/svg_images/single_tracking.svg"
                            isActiveMenu: false
                            onClicked: {
                        ...
                        LeftMenuBtn {
                            id: btnMultiObjectTracking
                            width: leftMenu.width
                            text: qsTr("Multi Object Tracking")
                            btnIconSource: "../ui/images/svg_images/multi_tracking.svg"
                            isActiveMenu: false
                            onClicked: {
...
//                        }
                    ...
                    LeftMenuBtn {
                        ...
                        btnIconSource: "../ui/images/svg_images/settings_icon.svg"
                        onClicked: {
                            if(btnSettings.isActiveMenu == false) {
                                internal.pageNavigation("pages/settingsPage.qml")
                ...
                Rectangle {
                    ...
                    MouseArea {
                        ...
                        Image {
                            ...
                            height: 16
                            anchors.fill: parent
                            source: "../ui/images/svg_images/resize_icon.svg"
                            anchors.leftMargin: 5
                            anchors.topMargin: 5
