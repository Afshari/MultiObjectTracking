...
Hungarian::Hungarian(QObject *parent) : QObject(parent) {

}

tuple<vector<int>, double> Hungarian::Solve(const MatrixXd &L) {
...
//    }
    ...
    double cost = Solve(DistMatrix, assignment);

    tuple<vector<int>, double> result(assignment, cost);
    return result;
}
